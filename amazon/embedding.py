...
np.save("amazon_u_sim.npy", u_sim.cpu().numpy())
np.save("amazon_i_agg.npy", i_agg.cpu().numpy())
np.save("amazon_u_agg.npy", u_agg.cpu().numpy())
np.save("amazon_i_sim.npy", i_sim.cpu().numpy())